...
public class EcoIssueContract implements Contract {

    public static String ID = "com.example.contract.EcoIssueContract";

    private static final Logger logger = LoggerFactory.getLogger(EcoIssueContract.class);
